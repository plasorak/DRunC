...
from druncschema.controller_pb2 import FSMTransitionResponse, FSMResponseFlag
...
class ClientSideChild(ChildNode):
    def __init__(self, name, node_type: ControlType = ControlType.Direct, fsm_configuration = None, configuration = None): #
        super().__init__(
            name = name,
            node_type = node_type,
